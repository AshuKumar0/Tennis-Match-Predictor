...
r16 = [
    ...
    ("Eliot Spizzirri", "Nuno Borges"),
    ("Brandon Nakashima", "Marcos Giron"),
    ("Yannick Hanfmann", "Vit Kopriva"),
    ("Sebastian Korda", "Damir Dzumhur"),
    ("Miomir Kecmanovic", "Luciano Darderi"),
    ("Alexandre Muller", "Tomas Martin Etcheverry"),
    ("Stan Wawrinka", "Lorenzo Musetti")
]

winners = []
print("\n===== Round of 16 =====")
for playerA, playerB in r16:
